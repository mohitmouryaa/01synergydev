...
gsap.config({ nullTargetWarn: !1 }), gsap.to(".blur-circle", { scale: 1, opacity: 0.3, delay: 0.35, duration: 1, ease: "power4.inOut" });
let thisClass,
  scrollFixCta,
  ctaFixIn,
  mouseX = 0,
...
if (isMobile()) {
  function pageOut() {
    ...
    return (
      ...
      e.to(".page-to-page svg:nth-of-type(2)", { duration: 0.8, ease: "expo.in" }, "<"),
      e.to("#pageBgAnim", { morphSVG: page3, duration: 0.8, ease: "expo.out" }),
      e.to(".page-to-page svg:nth-of-type(2)", { duration: 0.8, ease: "expo.out" }, "<"),
      e
    );
  }
  function pageIn() {
    let e = gsap.timeline();
    return (
      e.to("#pageBgAnim2", { delay: 0.2, morphSVG: page2, duration: 0.8, ease: "expo.in" }),
      e.to(".page-to-page svg:first-of-type", { yPercent: 100, duration: 0.8, ease: "expo.in" }, "<"),
      e.to("#pageBgAnim2", { morphSVG: shapeStart, duration: 0.8, ease: "expo.out" }),
      e.to(".page-to-page svg:first-of-type", { yPercent: 100, duration: 0.8, ease: "expo.out" }, "<"),
      e
    );
  }
} else if (!isMobile()) {
  function pageOut() {
    ...
    return (
      e.to("#pageBgAnim", { morphSVG: page2, duration: 0.8, ease: "expo.in" }),
      e.to(".page-to-page svg:nth-of-type(2)", { yPercent: 50, duration: 0.8, ease: "expo.in" }, "<"),
      e.to("#pageBgAnim", { morphSVG: page3, duration: 0.8, ease: "expo.out" }),
      e.to(".page-to-page svg:nth-of-type(2)", { yPercent: 100, duration: 0.8, ease: "expo.out" }, "<"),
      e
    );
  }
  function pageIn() {
    ...
    return (
      e.to("#pageBgAnim2", { delay: 0.2, morphSVG: page2, duration: 0.8, ease: "expo.in" }),
      e.to(".page-to-page svg:first-of-type", { yPercent: 50, duration: 0.8, ease: "expo.in" }, "<"),
      e.to("#pageBgAnim2", { morphSVG: shapeStart, duration: 0.8, ease: "expo.out" }),
      e.to(".page-to-page svg:first-of-type", { yPercent: 100, duration: 0.8, ease: "expo.out" }, "<"),
      e
    );
...
let smoother,
  easeValA = "M0,0 C0,0 0.236,-0.014 0.337,0.114 0.485,0.302 0.314,0.662 0.514,0.86 0.681,1.026 1,1 1,1",
...
function smoothScroll() {
  if (!isMobile() && window.innerWidth > 768) {
    (smoother = ScrollSmoother.create({ wrapper: "#smooth-wrapper", content: ".content", smooth: 1.2, effects: !0, normalizeScroll: !0 })),
...
gsap.set(navLink, { pointerEvents: "none" }), gsap.set([social, navLink], { opacity: 0 });
const menuOpen = function () {
  menuBgAnim.to("#pageBgAnim", { morphSVG: menuMid, duration: 0.6, ease: "expo.in" }),
    menuBgAnim.to("#pageBgAnim", { morphSVG: menuEnd, duration: 0.6, ease: "expo.out" }),
    isMobile()
      ? isMobile() && menuBgAnim.to(".page-to-page svg", { yPercent: 0, duration: 0.6, ease: "expo.out" }, "<")
      : menuBgAnim.to(".page-to-page svg", { yPercent: 63, duration: 0.6, ease: "expo.out" }, "<");
  (lineB = "M21 30H9"),
    ...
    hambIcon.to(".lineA", { morphSVG: "M5.07849 34.5V35", duration: 1, ease: "power4.inOut" }),
  ...
  (menuInner = gsap.timeline({
    onStart: function () {
      wrapper.classList.add("is-exiting"),
        ...
        gsap.to(".page-to-page svg:first-of-type", { opacity: 0, duration: 0.3 });
    },
    onReverseComplete: function () {
      wrapper.classList.remove("is-exiting"),
        gsap.to(glContainer, { opacity: 1, duration: 0.3, ease: "power4" }),
        gsap.to(".page-to-page svg:first-of-type", { opacity: 1, duration: 0.3 }),
    ...
    menuInner.to(social, { y: "150%", opacity: 1, duration: 0.6, ease: "power4" }, "-=.5");
};
function triggerDotAnim() {
  ...
  i.to(["#logo", "#hamburger"], {
    ...
    i.to("#pageBgAnim", { morphSVG: { shape: easterPath, type: "rotational" }, duration: 1.5, ease: customEaseC }, "<"),
    i.to("#blurDeviation", { duration: 1.5, attr: { stdDeviation: 17 }, ease: customEaseC }, "<"),
    i.to(
      e,
      {
        x: 0,
  ...
  gsap.set(".about #hero h1", { perspective: 400 }),
    gsap.set(u.chars, { transformOrigin: "0% 100%", scale: 6, opacity: 0, rotate: 45, y: window.innerHeight });
  ...
  gsap.utils.toArray("#magic-keys p").forEach((e) => {
    ...
    gsap.set(t.chars, { yPercent: -105, opacity: 0, scaleY: 0.5 }),
      d.to(t.chars, { yPercent: 0, opacity: 1, scaleY: 1, duration: 0.5, stagger: { amount: 0.1 }, ease: "power4" }),
      d.to(t.chars, { yPercent: 105, duration: 0.5, delay: 0.8, opacity: 0, scaleY: 0.5, stagger: { amount: 0.1 }, ease: "power4.in" });
  });
  ...
  (g.volume = 0),
    ...
    n.to(".about h1 div div div", { opacity: 0, y: 20, duration: 1, stagger: { amount: 0.25 }, ease: "expo.inOut" }),
    n.to(["#breadcrumb", "#fixed-cta", ".scroll-to"], { opacity: 0, duration: 1, pointerEvents: "none", ease: "power4" }, "<"),
    n.to(l, {
      scale: 1,
      duration: 0.75,
      ease: "power4",
      onComplete: () => {
        d.play(),
          l.addEventListener("mouseenter", function () {
            gsap.to("#magic-close div", { scale: 1.2, duration: 1, ease: "elastic" }),
              gsap.to("#magic-close i:first-of-type", { rotateZ: 0, duration: 0.5, ease: "expo" }),
              gsap.to("#magic-close i:nth-of-type(2)", { rotateZ: 0, duration: 0.5, ease: "expo" });
          }),
          l.addEventListener("mouseleave", function () {
            gsap.to("#magic-close div", { scale: 1, duration: 1, ease: "elastic" }),
              gsap.to("#magic-close i:first-of-type", { rotateZ: 45, duration: 1, ease: "elastic" }),
              gsap.to("#magic-close i:nth-of-type(2)", { rotateZ: -45, duration: 1, ease: "elastic" });
          });
      },
    }),
    n.to("#magic-keys", {
    ...
    l.addEventListener("click", function () {
      ...
      i.reverse().timeScale(-2), gsap.delayedCall(0.5, p), bodyTag.classList.remove("easterOn"), r.classList.remove("active");
    });
}
if (
  (menuOpen(),
  hamburger.addEventListener("click", function () {
    ...
    hamburger.classList.contains("active")
      ...
      : (hambIcon.restart(),
        ...
        document.querySelector("#fixed-cta") && e.classList.contains("active") && gsap.to(e, { opacity: 0, duration: 0.2, ease: "power4" }),
  ...
  gsap.set(".about #hero h1", { perspective: 400 }),
    gsap.set(t.chars, { transformOrigin: "0% 100%", scale: 6, opacity: 0, rotate: 45, y: window.innerHeight }),
    gsap.to(t.chars, {
      transformOrigin: "0% 100%",
      scale: 1,
      opacity: 1,
          ...
          a = () => {
            (o.onload = () => {
              (o.onload = null),
                (o.src = e.src),
                (e.src = t),
                gsap.set(o, { position: "absolute", top: e.offsetTop, left: e.offsetLeft, width: e.offsetWidth, height: e.offsetHeight }),
                e.parentNode.appendChild(o),
                gsap.to(o, { opacity: 0, duration: 0.35, onComplete: () => o.parentNode.removeChild(o) }),
                s && s.kill();
            }),
              (o.src = t);
          },
          s = ScrollTrigger.create({ trigger: e, start: "-50% bottom", onEnter: a, onEnterBack: a });
      }));
  },
  mainScripts: function () {
    if (
      ...
      let u = new SplitText(l, { type: "chars" }),
        d = gsap.timeline({
          scrollTrigger: { trigger: l, start: "top 50%", end: "bottom -=310%", toggleActions: "play reverse play reverse", scrub: 0.2 },
        });
      d.from(u.chars, { y: (e) => 100 * e, duration: 1, ease: "linear" }),
        d.to(c, { webkitClipPath: "inset(0% 0% 0% 0%)", duration: 3, ease: "linear" }),
        d.to(c, { webkitClipPath: "inset(0% 100% 0% 0%)", duration: 5, ease: "linear" }),
        d.to(u.chars, { y: (e) => -100 * e - 550, duration: 1, ease: "linear" });
      let g = gsap.timeline({ scrollTrigger: { trigger: l, start: "bottom -=250%", toggleActions: "restart none none none" } });
      g.to(".hex-wrap .shape-anim polyline", { drawSVG: "0% 100%", duration: 0.5, stagger: 0.1, ease: "power4.in" }),
        g.to(".hex-wrap .shape-anim polyline", { drawSVG: "100% 100%", duration: 0.5, stagger: 0.1, ease: "power4.out" }, "-=.3");
    }
    if (document.querySelector("#attitude") && isAndroid()) {
      ...
      let i = gsap.timeline({ scrollTrigger: { trigger: e, start: "top top", end: () => "+=" + s * t.length, pin: !0, scrub: !0 } });
    ...
    if (document.querySelector(".client-wrap") && !isMobile()) {
      ...
      const r = gsap.timeline({
        scrollTrigger: { trigger: ".client-wrap", id: "clientPin", start: "top 20%", end: "bottom top", pin: "#clients", scrub: !0 },
      });
      r.to(e, { x: -i, ease: "linear" }), r.to(t, { x: n, ease: "linear" }, "<");
      ...
      g.to(u, { duration: 0.3, scale: 1.3, delay: 0.5, ease: "power3.in" }),
        ...
        d.forEach((e) => {
          e.addEventListener("mouseenter", function () {
            ...
            g.pause(), gsap.to(t, { opacity: 1, scale: 1, duration: 0.4, ease: "power4" }), u.classList.add("invisible");
          }),
            e.addEventListener("mouseleave", function () {
              const e = this.dataset.client,
                t = document.querySelector('[data-stat="' + e + '"]');
              gsap.to(t, { opacity: 0, scale: 0.5, duration: 0.4, ease: "power4" }), u.classList.remove("invisible"), g.restart();
            });
        });
    }
    ...
    let a = 0,
      s = -0;
    if ((gsap.set(t.chars, { yPercent: 102 }), document.querySelector(".button-switch"))) {
      const e = document.querySelector(".button-switch"),
        ...
        r = function () {
          i.to(e.querySelector("i:first-of-type"), { scale: 0.55, duration: 0.2, ease: "back" }),
            i.to(e.querySelector("i:nth-of-type(2)"), { scale: 0.7, duration: 0.2, ease: "back" }, "<"),
            i.to(e.querySelector("i:nth-of-type(3)"), { scale: 0.85, duration: 0.2, ease: "back" }, "<"),
            i.to(
        ...
        c = function () {
          ...
          e.to(i, { yPercent: -110, stagger: { amount: 0.1 }, duration: 1, ease: "elastic" }),
            e.to(
              n,
              {
                yPercent: 0,
    ...
    if (document.querySelector(".usp-carousel")) {
      let e = document.querySelectorAll(".usp-carousel .inner"),
        ...
        i = s * (t - 1) + a;
      gsap
        .timeline({ repeat: 20, scrollTrigger: { trigger: ".usp-carousel", start: "top 90%", toggleActions: "play pause play none" } })
        .from(e, { y: "100%", duration: o, stagger: { each: s, repeat: -1, repeatDelay: i } })
        .to(e, { y: "-100%", duration: o, stagger: { each: s, repeat: -1, repeatDelay: i } }, s);
    }
      ...
      const n = function () {
        ...
        (newValue = e.getBoundingClientRect().top),
          i < newValue
            ...
            : i > newValue && (gsap.to(o, { y: 0 }), gsap.to(a, { y: 100 * -l + "%" })),
          (i = newValue),
          (s = t),
    ...
    if (document.querySelector("#fixed-cta")) {
      ...
      (function () {
        ...
        o.to(".handle-b", { transformOrigin: "bottom right", scale: 0.2, opacity: 0, x: 30, y: 30, duration: 0.6, ease: "expo.out" }),
          o.to(".tip-b", { transformOrigin: "bottom right", scale: 0.2, opacity: 0, x: 30, y: 30, duration: 0.6, ease: "expo.out" }, "<"),
          o.to(
            ".handle-a",
            {
              opacity: 1,
          ...
          o.to(".tip-a", { opacity: 1, morphSVG: "M49.7919 50.1349L45 49L49 45L49.7919 50.1349Z", duration: 0.6, ease: "expo.out" }, "<");
        e.addEventListener("mouseenter", function () {
          o.restart(), gsap.to(t, { scale: 1.25, duration: 1, ease: "elastic" });
        }),
          e.addEventListener("mouseleave", function () {
            gsap.to(t, { scale: 1, duration: 1, ease: "elastic" });
          }),
        ...
        (scrollFixCta = function () {
          (ctaFixIn = gsap.timeline({
            paused: !0,
            scrollTrigger: { trigger: ".contact-link", start: "bottom bottom", toggleActions: "play pause play reverse" },
          })),
    ...
    if (
      (document.querySelector(".view") &&
        ...
        isMobile()
          ? ScrollTrigger.batch(".view", {
              scroller: "body",
              start: "top 90%",
              onEnter: (e) => gsap.to(e, { opacity: 1, duration: 0.8, y: 0, stagger: 0.1, ease: customEaseB }),
            })
          : ScrollTrigger.batch(".view", {
              start: "top bottom",
              onEnter: (e) => gsap.to(e, { opacity: 1, duration: 0.9, y: 0, stagger: 0.1, ease: customEaseB }),
              onLeaveBack: (e) => gsap.to(e, { opacity: 0, duration: 0.2, y: "100%", stagger: 0.1, ease: customEaseA }),
            })),
      document.querySelector(".img-view") &&
        ...
        isMobile()
          ? ScrollTrigger.batch(".img-view", {
              scroller: "body",
              start: "top 90%",
              onEnter: (e) => gsap.to(e, { opacity: 1, duration: 0.8, y: 0, stagger: 0.1, ease: "expo" }),
            })
          : ScrollTrigger.batch(".img-view", {
              start: "top 99%",
              onEnter: (e) => gsap.to(e, { opacity: 1, duration: 1, y: 0, stagger: 0.1, ease: "expo" }),
            })),
      ...
      gsap.utils.toArray(".section-title").forEach((e) => {
        ...
        const a = gsap.timeline({ scrollTrigger: { trigger: e, start: "top 90%" } });
        a.to(e, { x: 0, opacity: 1, duration: 1, ease: "power3" }),
          ...
          a.to(o, { scale: 1, opacity: 1, duration: 0.1, ease: "power3" }, "-=.1"),
    ...
    if (document.querySelector(".side-scroll") && !isMobile()) {
      ...
      o.to(e, { yPercent: (e) => 10 * (e + 1) - 100, scale: 0.9, stagger: 0.5, duration: 0.5, ease: "linear" }),
        o.to(t, { backgroundColor: "#171A37", stagger: 0.5, duration: 0.5, ease: "linear" }, "<");
    }
    if (document.querySelector(".mask-link") && !isMobile()) {
      gsap.utils.toArray(".mask-link").forEach((e) => {
        ...
        e.addEventListener("mouseenter", function () {
          ...
          this.classList.add("hovered"), gsap.to(t, { x: -e, duration: 0.5, scale: 0, ease: "power4.inOut" });
        }),
          e.addEventListener("mouseleave", function () {
            this.classList.remove("hovered"), gsap.to(t, { x: 0, duration: 0.5, scale: 1, ease: "power4.inOut" });
          });
      });
    }
    ...
    if (
      (Promise.all([i.load(), n.load()]).then(function () {
        ...
        gsap.set(".split", { perspective: 400 }),
          ...
          ScrollTrigger.batch(e.chars, {
            start: "top 90%",
            onEnter: (e) => gsap.to(e, { transformOrigin: "0% 100%", duration: 1, stagger: { amount: 0.2 }, y: "0%", ease: customEaseA }),
          }),
          gsap.set(t.lines, { opacity: 0, y: "150%" }),
          ScrollTrigger.batch(t.lines, {
            start: "top 100%",
            toggleActions: "restart none none none",
            onEnter: (e) => gsap.to(e, { opacity: 1, duration: 1, y: 0, stagger: 0.03, ease: "expo.out" }),
            onLeaveBack: (e) => gsap.to(e, { opacity: 0, y: "150%", stagger: 0.03, ease: "power4" }),
          });
        ...
        gsap.set(".hero-split", { perspective: 400 }),
          gsap.set(i.chars, { transformOrigin: "0% 100%", scale: 6, opacity: 0, rotate: 45, y: window.innerHeight }),
          gsap.set(a, { perspective: "400px", y: 30, transformOrigin: "50% 100%", opacity: 0 }),
          ...
          document.querySelector(".about")
            ? (heroAnim.to(a, {
              ...
              heroAnim.to(".hero-hex polyline", { drawSVG: "0% 100%", duration: 0.5, stagger: 0.1, ease: "power4.in" }, "-=.7"),
              heroAnim.to(".hero-hex polyline", { drawSVG: "100% 100%", duration: 0.5, stagger: 0.1, ease: "power4.out" }),
              heroAnim.play())
            : (heroAnim.to(i.chars, {
                delay: 0.5,
                transformOrigin: "0% 100%",
              ...
              heroAnim.to(
                a,
                { scale: 1, opacity: 1, transformOrigin: "50% 100%", y: 0, stagger: { amount: 0.2 }, duration: 0.6, ease: customEaseB },
                "<.6"
              ),
              heroAnim.to(
                s,
        ...
        gsap.utils.toArray(".line-anim").forEach((e) => {
          const t = e.querySelector("svg:first-of-type"),
            ...
            i = gsap.timeline({ scrollTrigger: { trigger: e, start: "top 80%" } });
          i.from([o, t], { opacity: 0, scale: 0, duration: 0.5, ease: customEaseB }),
      ...
      if (!isMobile()) {
        const e = function () {
          ...
          const a = c.offsetHeight / 2,
            s = c.offsetWidth / 2;
          gsap.to(c, { y: ballY - a, x: ballX - s, ease: "none", duration: 0.15 });
          ...
          gsap.to(o, { scale: 1 - p / 5 }), gsap.to(r, { scaleX: m }), (d = i), requestAnimationFrame(e);
        };
        e();
      }
      Draggable.create(".draggable .slider-inner", {
        ...
        e.addEventListener("mouseenter", function () {
          c.classList.add("moving"), gsap.to(l, { scale: 1, duration: 0.4, ease: "power4" }), bodyTag.style.setProperty("cursor", "none");
        }),
        e.addEventListener("mousedown", function () {
          e.classList.add("down"), c.classList.add("is-on"), gsap.to(l, { scale: 0.8, duration: 0.4, ease: "power4" });
        }),
        e.addEventListener("mouseup", function () {
          e.classList.remove("down"), c.classList.remove("is-on"), gsap.to(l, { scale: 1, duration: 0.4, ease: "power4" });
        }),
        e.addEventListener("mouseleave", function () {
    ...
    if (document.querySelector(".timeline") && !isMobile()) {
      ...
      (t.style.transform = `translateX(${c + "px"}) translateY(${n + "px"}) scale(.8)`), gsap.set(o, { opacity: 0 });
      ...
      const u = function () {
        ...
        gsap.to(".ts-item", { scale: 1 - a / 2, ease: "linear" }), (l = e), requestAnimationFrame(u);
      };
      u();
      let d = 0;
      ...
      p.to(e, { y: i, x: "-20%", scale: 0.8, duration: 0.2, ease: "linear" }),
        ...
        p.to(o, { y: "60%", opacity: 1, duration: 0.1, ease: "linear" }, "-=.2");
      ...
      gsap.set(s, { opacity: 0 }), gsap.set(a, { yPercent: (e) => 10 * (e + 1) + 100, scale: 0.9 });
      let i = gsap.timeline({
        scrollTrigger: {
          trigger: ".timeline",
          start: "top 10%",
      ...
      i.to(e, { opacity: 0, scale: 0.5, duration: 0.5, ease: "linear" }),
        i.to(t, { transformOrigin: "top left", yPercent: -120, scale: 1.2, duration: 1, stagger: 1, ease: "linear" }, "<"),
        i.to(a, { yPercent: (e) => 10 * (e + 1), scale: 1, duration: 1, stagger: 1, ease: "linear" }, "<"),
        i.to(t, { transformOrigin: "0% 0%", yPercent: -100, opacity: 0, scale: 0.5, duration: 1, stagger: 1, ease: "linear" }, "-=8"),
    ...
    if (document.querySelector(".lifecycle") && window.innerWidth > 1024) {
      ...
      for (
        e.forEach((e) => {
          ...
          (o = 2 * a.offsetHeight),
            e.classList.contains("active") ||
              (gsap.to(t, { rotation: -90, scale: 0.4, y: o, transformOrigin: "0 0" }),
          ...
          if (!this.classList.contains("active")) {
            ...
            for (let t = 0; t < e.length; t++) {
              ...
              (o = 2 * s.offsetHeight),
                ...
                gsap.to(a, { rotation: -90, scale: 0.4, y: o, transformOrigin: "0 0", duration: 0.5, ease: "expo" }),
                gsap.to(s, { x: 100, opacity: 0, transformOrigin: "0 0", duration: 0.5, ease: "expo" });
            }
          }
          this.classList.add("active"),
            gsap.to(e, { rotation: 0, y: 0, scale: 1, transformOrigin: "0 0", duration: 0.5, ease: "expo" }),
      ...
      (document.querySelector(".lifecycle").style.marginBottom = "35vh"),
        ...
        gsap
          ...
          .to(e, { yPercent: (e) => 10 * (e + 1) - 100, scale: 1, stagger: 0.5, duration: 0.5, ease: "linear" });
    }
    if (document.querySelector(".services .goal") && window.innerWidth > 768) {
      gsap.utils.toArray(".goal-boxes article").forEach((e) => {
        ...
        e.addEventListener("mouseenter", function () {
          ...
          e.addEventListener("mouseleave", function () {
            gsap.to(t, { height: "100%", minHeight: 400, duration: 1, ease: "elastic.out" });
          });
      });
    }
    if (document.querySelector(".contact")) {
      ...
      gsap.set(a, { opacity: 0, pointerEvents: "none" }),
        a.addEventListener("mouseenter", function () {
          gsap.to(".step-back i", { scale: 1.25, duration: 1, ease: "elastic" });
        }),
        ...
        e.forEach((e) => {
          e.addEventListener("click", function () {
            ...
            if (!e.classList.contains("step-first")) {
              ...
              setTimeout(function () {
                (o.parentNode === t ? r : t).appendChild(o), Flip.from(a, { duration: 0.5, scale: !0, ease: "power4" });
              }, 50);
            }
            if (
              (a.setAttribute("data-state", `${i}`),
              gsap.to(a, { opacity: 1, duration: 0.4, pointerEvents: "auto", ease: "power4" }),
            ...
            gsap.to(t, { scaleX: 0.2 * n, duration: 0.4, ease: "power4" }),
              document.querySelector('[data-step="5"]').classList.contains("active") &&
                (o.classList.add("last"), gsap.to(".progress-total", { opacity: 1, duration: 0.4, ease: "power4" }));
          });
        }),
        ...
        a.addEventListener("click", function () {
          ...
          document.querySelector('[data-step="1"]').classList.contains("active") &&
            gsap.to(a, { opacity: 0, duration: 0.4, pointerEvents: "none", ease: "power4" }),
            document.querySelector('[data-step="5"]').classList.contains("active") ||
              (o.classList.remove("last"), gsap.to(".progress-total", { opacity: 0.3, duration: 0.4, ease: "power4" })),
    ...
    if (document.querySelector(".work-listing")) {
      document.querySelectorAll(".work-listing article:not(.selected)").forEach((e) => {
        ...
        c.to(i, { morphSVG: r, duration: 0.7, ease: "power4.in" }),
          c.to(s, { opacity: 1, y: 0, duration: 1.4, filter: "brightness(1)", ease: "power4.inOut" }, "<"),
          c.to(
            i,
            {
              morphSVG:
        ...
        if (
          (gsap.timeline({ scrollTrigger: { trigger: e, start: "top 70%" } }).to(t, {
            opacity: 1,
            duration: 0.01,
            onComplete: function () {
              c.play();
          ...
          t.to(e.chars, { yPercent: 0, stagger: { amount: 0.1 }, duration: 0.3, ease: "power4.inOut" }),
    ...
    if (document.querySelector(".big-fade")) {
      gsap.utils.toArray(".big-fade").forEach((e) => {
        ...
        gsap
          .timeline({
            scrollTrigger: { trigger: e, start: "top 90%", end: "top top", toggleActions: "play reverse reverse none", scrub: !0 },
          })
          .from(t.chars, { yPercent: 100, scale: 2, color: "#000", stagger: 0.1, duration: 1, ease: "power2" });
      });
    }
    if (document.querySelector("#awards") && !isMobile()) {
      ...
      ScrollTrigger.create({
        ...
        s.to(t, { y: 0, color: "#171A37", scale: 1, duration: 4, stagger: { amount: 3 }, ease: "power1.Out" }),
        s.to(
          o,
          {
            y: "-85vh",
    ...
    if (document.querySelector(".work")) {
          ...
          o.forEach((e) => {
            ...
            e.addEventListener("mouseenter", function () {
              ...
              MainThreeScene.changeTexture(a, !1),
                ...
                gsap.to(o, { opacity: 1, y: "135%", duration: 0.4, ease: "power4" });
            }),
              e.addEventListener("mouseleave", function () {
                e.classList.remove("hovered"),
                  gsap.to(t, { scale: 0.8, duration: 0.4, ease: "power4" }),
                  gsap.to(o, { opacity: 0, y: "160%", duration: 0.4, ease: "power4" });
              }),
              e.addEventListener("click", function () {
                gsap.to(glContainer, { y: "0%", duration: 1, ease: customEaseC });
              });
          });
        };
      ...
      isMobile()
        ? (g.to(glContainer, { y: "-13%", duration: 1, ease: customEaseC }),
          g.to(".open-thumbs", { opacity: 0, duration: 1, ease: customEaseC }, "<"),
          g.to(".close-thumbs", { opacity: 1, duration: 1, ease: customEaseC }, "<"),
          ...
          g.to(n, { opacity: 0, y: 10, scale: 0, stagger: { amount: 0.1, from: "center" }, duration: 0.5, ease: customEaseC }, "<"),
          g.to(s, { opacity: 1, rotateZ: -135, duration: 0.5, ease: customEaseC, onComplete: l }, "<.2"),
          p.to(glContainer, { y: "0%", duration: 1, ease: customEaseC }),
          p.to(".open-thumbs", { opacity: 1, y: 0, duration: 1, ease: customEaseC }, "<"),
          p.to(".close-thumbs", { opacity: 0, duration: 1, ease: customEaseC }, "<"),
          ...
          p.to(s, { opacity: 0, rotateZ: 90, duration: 0.5, ease: customEaseC }, "<"),
          p.to(n, { opacity: 1, y: 0, scale: 1, stagger: { amount: 0.1, from: "center" }, duration: 0.5, ease: customEaseC }, "<.2"))
        : (g.fromTo(glContainer, { y: "0%", duration: 1, ease: customEaseC }, { y: "-13%", duration: 1, ease: customEaseC }),
          g.to(".open-thumbs", { opacity: 0, y: "-1em", duration: 1, ease: customEaseC }, "<"),
          g.to(".close-thumbs", { opacity: 1, duration: 1, ease: customEaseC }, "<"),
      ...
      let h = 0,
        ...
        T = [
          "<a href='../work/slingshot' class='circle-link'><div class='circle-icon'><i></i><span><img src='../images/arrow-hex.svg' alt='arrow icon with hexagon tip'><img src='../images/arrow-hex.svg'></span></div>Sling Shot</a>",
          "<a href='../work/opositive' class='circle-link'><div class='circle-icon'><i></i><span><img src='../images/arrow-hex.svg' alt='arrow icon with hexagon tip'><img src='../images/arrow-hex.svg'></span></div>O Positive</a>",
          "<a href='../work/valaclava' class='circle-link'><div class='circle-icon'><i></i><span><img src='../images/arrow-hex.svg' alt='arrow icon with hexagon tip'><img src='../images/arrow-hex.svg'></span></div>Valaclava</a>",
          "<a href='../work/hoboken-yogi' class='circle-link'><div class='circle-icon'><i></i><span><img src='../images/arrow-hex.svg' alt='arrow icon with hexagon tip'><img src='../images/arrow-hex.svg'></span></div>Hoboken Yogi</a>",
          "<a href='../work/ocean-agency' class='circle-link'><div class='circle-icon'><i></i><span><img src='../images/arrow-hex.svg' alt='arrow icon with hexagon tip'><img src='../images/arrow-hex.svg'></span></div>Ocean Agency</a>",
          "<a href='../work/beemok' class='circle-link'><div class='circle-icon'><i></i><span><img src='../images/arrow-hex.svg' alt='arrow icon with hexagon tip'><img src='../images/arrow-hex.svg'></span></div>Beemok Col</a>",
          "<a href='../work/hudson-properties' class='circle-link'><div class='circle-icon'><i></i><span><img src='../images/arrow-hex.svg' alt='arrow icon with hexagon tip'><img src='../images/arrow-hex.svg'></span></div>Hudson Prop.</a>",
          "<a href='../work/helias' class='circle-link'><div class='circle-icon'><i></i><span><img src='../images/arrow-hex.svg' alt='arrow icon with hexagon tip'><img src='../images/arrow-hex.svg'></span></div>Helias Oils</a>",
          "<a href='../work/modern-md' class='circle-link'><div class='circle-icon'><i></i><span><img src='../images/arrow-hex.svg' alt='arrow icon with hexagon tip'><img src='../images/arrow-hex.svg'></span></div>Modern MD</a>",
        ],
        ...
        Z = function () {
          ...
          P.forEach((e) => {
            ...
            e.classList.contains("selected") &&
              ...
              V.to(e, { zIndex: 1, transformOrigin: "50% 0%", duration: 0.001, ease: "none" }),
              V.to(e, { scale: 1.5, opacity: 0, duration: 1, ease: "power4" }),
              V.to(e, { scale: 1, duration: 0.001, ease: "linear" })),
              t == h &&
                (e.classList.add("selected"),
                H.to(e, { transformOrigin: "50% 100%", opacity: 0, zIndex: 10, scale: 1.35, duration: 0.001, ease: "none" }),
                H.to(e, { y: 0, opacity: 1, scale: 1, duration: 1, ease: "power4" }));
          }),
            O.to("#work-titles h2", { y: "100%", duration: 1, ease: "power4" }),
            O.to("#work-titles h2 .circle-icon", { scale: 0, duration: 0.25, ease: "power4" }, "<"),
            O.to("#work-titles #curTitle", { transformOrigin: "0 0", rotateZ: 20, duration: 1, ease: "power4" }, "<"),
            O.fromTo(
              "#work-titles #prevTitle",
              { transformOrigin: "0 0", rotateZ: -20 },
              { transformOrigin: "0 0", rotateZ: 0, duration: 1, ease: "power4" },
              "<"
            ),
            O.to(".work-service ul", { y: "100%", duration: 1, ease: "power4" }, "<"),
            O.to(
              "#slide-count li",
              {
                y: "100%",
                ...
                onComplete: function () {
                  O.to("#slide-count li", { y: "0%", duration: 0.001 }),
                    O.to("#work-titles h2", { y: "0%", rotateZ: 0, duration: 0.001 }),
                    O.to("#work-titles h2", { y: "0%", rotateZ: 0, duration: 0.001 }),
            ...
            O.to("#work-titles h2 .circle-icon", { scale: 1, duration: 0.4, ease: "power4" }, "-=.7");
        },
        D = function () {
          if (O.isActive()) return;
          (h += 1),
          ...
          P.forEach((e) => {
            ...
            e.classList.contains("selected") &&
              (e.classList.remove("selected"),
              V.to(e, { zIndex: 1, transformOrigin: "50% 100%", duration: 0.001, ease: "none" }),
              V.to(e, { scale: 1.5, opacity: 0, duration: 1, ease: "power4" }),
              V.to(e, { scale: 1, duration: 0.001, ease: "linear" })),
              t == h &&
                (e.classList.add("selected"),
                H.to(e, { transformOrigin: "50% 0%", opacity: 0, zIndex: 10, scale: 1.35, duration: 0.001, ease: "none" }),
                H.to(e, { y: 0, opacity: 1, scale: 1, duration: 1, ease: "power4" }));
          }),
            O.to("#work-titles h2", { y: "-100%", duration: 1, ease: "power4" }),
            O.to("#work-titles h2 .circle-icon", { scale: 0, duration: 0.25, ease: "power4" }, "<"),
            ...
            O.to("#work-titles h2 .circle-icon", { scale: 1, duration: 0.4, ease: "power4" }, "-=.5");
        };
      window.addEventListener("wheel", function (t) {
        e.classList.contains("muted") ||
          (document.querySelector(".content").classList.contains("work") && (t.deltaY < 0 ? Z() : t.deltaY > 0 && D()));
      });
        ...
        if (!g.isActive())
          if (this.classList.contains("switched"))
            this.classList.remove("switched"),
              ...
              y(),
              p.to("[data-layout='1']", { opacity: 1, pointerEvents: "auto", duration: 0.5, ease: "power4.inOut" }, "<.65"),
              MainThreeScene.changeTexture(h, !1);
          else {
            if (p.isActive()) return;
            this.classList.add("switched"),
              e.classList.add("muted"),
              a.to("[data-layout='1']", { opacity: 0, pointerEvents: "none", duration: 0.5, ease: "power4.inOut" }),
              m();
          }
      });
    }
    if (document.querySelector(".work-detail")) {
      ...
      if (
        (e.addEventListener("mouseenter", function () {
          t.classList.add("hovering"), e.classList.add("hovering"), gsap.to(t, { x: 10, duration: 0.5, ease: "power4" });
        }),
        e.addEventListener("mouseleave", function () {
          t.classList.remove("hovering"), e.classList.remove("hovering"), gsap.to(t, { x: 0, duration: 0.5, ease: "power4" });
        }),
          ...
          e.forEach((e) => {
            ...
            o.forEach((e) => {
              e.addEventListener("mouseenter", function () {
                ...
                e.addEventListener("mouseleave", function () {
                  t.classList.remove("moving"), gsap.to(t, { scale: 0, duration: 0.35, ease: "expo" });
                });
              ...
              o.forEach((e) => {
                e.addEventListener("click", function () {
                  ...
                  e.classList.contains("selected") || e.classList.contains("disabled") || !o
                    ? e.classList.contains("selected") && !e.classList.contains("disabled") && o
                      ? (e.classList.remove("selected"),
                        t.classList.remove("active"),
                        gsap.to(s, { x: "0", delay: 0.1, duration: 1, ease: customEaseC }),
                        gsap.to(o, { x: "0", duration: 1, ease: customEaseC }))
                      : e.classList.contains("selected") || e.classList.contains("disabled") || !i
                      ? e.classList.contains("selected") &&
                        !e.classList.contains("disabled") &&
                        i &&
                        (e.classList.remove("selected"),
                        t.classList.remove("active"),
                        gsap.to(a, { x: "0", delay: 0.1, duration: 1, ease: customEaseC }),
                        gsap.to(i, { x: "0", duration: 1, ease: customEaseC }))
                      : (a.classList.remove("selected"),
                        e.classList.add("selected"),
                        t.classList.add("active"),
                        gsap.to(a, { x: "-20.833vw", duration: 1, ease: customEaseC }),
                        gsap.to(i, { x: "-20.833vw", delay: 0.1, duration: 1, ease: customEaseC }))
                    : (s.classList.remove("selected"),
                      e.classList.add("selected"),
                      t.classList.add("active"),
                      gsap.to(s, { x: "20.833vw", duration: 1, ease: customEaseC }),
                      gsap.to(o, { x: "20.833vw", delay: 0.1, duration: 1, ease: customEaseC }));
                });
              });
          });
      }
          ...
          c.clear(),
            ...
            document.querySelectorAll(".pg-left [data-list]").forEach((e) => {
              ...
              e.classList.contains("selected") &&
                ...
                c.to(e, { scale: 1.5, y: "75%", rotateZ: 15, duration: 1, ease: customEaseC }),
                c.to(e, { scale: 1, y: "-100%", rotateZ: 0, duration: 0.001, ease: "linear" })),
                t == o &&
                  (e.classList.add("selected"),
                  l.to(e, { zIndex: 10, scale: 1.35, duration: 0.001, ease: "none" }),
            ...
            u.clear(),
              ...
              document.querySelectorAll(".pg-right [data-list]").forEach((e) => {
                ...
                e.classList.contains("selected") &&
                  ...
                  u.to(e, { scale: 1.5, y: "75%", rotateZ: 15, delay: 0.05, duration: 1, ease: customEaseC }),
                  u.to(e, { scale: 1, y: "-100%", rotateZ: 0, duration: 0.001, ease: "linear" })),
                  t == a &&
                    (e.classList.add("selected"),
                    d.to(e, { zIndex: 10, scale: 1.35, duration: 0.001, ease: "none" }),
                    d.to(e, { y: 0, scale: 1, delay: 0.05, duration: 1, ease: customEaseC }));
              });
          })();
      });
    }
    if (document.querySelector("#intake-form")) {
      ...
      document.querySelector("#resetForm").addEventListener("click", function () {
        ...
        e.to("#i-form", { opacity: 0, y: 100, pointerEvents: "none", duration: 1, ease: "expo.inOut" }),
        e.to("#success-message", { opacity: 1, y: 0, pointerEvents: "auto", duration: 1, ease: "expo.inOut" }, "-=.95");
...
const glIn = function () {
    bodyTag.classList.contains("init") &&
      !isMobile() &&
      (MainThreeScene.start(), gsap.set(glContainer, { y: (e) => "+=" + -1 * e.offsetHeight, zIndex: 10 })),
      bodyTag.classList.contains("init") ||
        bodyTag.classList.contains("root") ||
        bodyTag.classList.contains("default") ||
        isMobile() ||
        (MainThreeScene.start(), gsap.set(glContainer, { y: (e) => "+=" + -1 * e.offsetHeight, zIndex: 2 }));
  },
  glOut = function () {
    bodyTag.classList.contains("init") &&
      !isMobile() &&
      (MainThreeScene.pause(), gsap.set(glContainer, { y: (e) => "+=" + -1 * e.offsetHeight, zIndex: 2 })),
      bodyTag.classList.contains("init") ||
        bodyTag.classList.contains("root") ||
        bodyTag.classList.contains("default") ||
        isMobile() ||
        (MainThreeScene.pause(), gsap.set(glContainer, { y: (e) => "+=" + -1 * e.offsetHeight, zIndex: 10 }));
  },
...
isMobile()
  ...
  : glScroll.to("#webglBubble", { y: () => "+=" + -1 * window.innerHeight, duration: 0.35, ease: "linear" });
...
const updateGl = function () {
  ...
  bodyTag.classList.contains("root")
    ...
    : (gsap.to(glContainer, { zIndex: 2, opacity: 1, scale: 0.7, xPercent: 0, yPercent: 0, y: "0%", duration: 0.75, ease: "power4.inOut" }),
    ...
    bodyTag.classList.contains("init") ||
      ...
      bodyTag.classList.contains("root") ||
      isMobile() ||
      gsap.to(glContainer, { zIndex: 2, opacity: 1, scale: 0.9, xPercent: 0, yPercent: 0, y: "0%", duration: 0.75, ease: "power4.inOut" }),
    bodyTag.classList.contains("init") ||
      bodyTag.classList.contains("default") ||
      bodyTag.classList.contains("root") ||
      !isMobile() ||
      (gsap.to(glContainer, { zIndex: 2, scale: 1, xPercent: 0, yPercent: 0, y: "0vh", duration: 0.75, ease: "power4.inOut" }),
      gsap.to(e, { y: "10vh" })),
    bodyTag.classList.contains("init") &&
      isMobile() &&
      (gsap.to(glContainer, { zIndex: 2, opacity: 1, scale: 1, xPercent: 0, yPercent: 0, y: "0vh", duration: 0.75, ease: "power4.inOut" }),
      gl.enable(),
      gsap.to(e, { y: "0vh" }),
      MainThreeScene.start()),
    bodyTag.classList.contains("default") &&
...
const changeTexture = function () {
  bodyTag.classList.contains("default") &&
    (MainThreeScene.changeTexture(0, !1), MainThreeScene.setParams({ mainBall: { reflectionColor: 1909061 } })),
    bodyTag.classList.contains("ssi") &&
      (MainThreeScene.changeTexture(0), MainThreeScene.setParams({ mainBall: { reflectionColor: 16777215 } })),
    bodyTag.classList.contains("op") &&
      (MainThreeScene.changeTexture(1), MainThreeScene.setParams({ mainBall: { reflectionColor: 6841187 } })),
    bodyTag.classList.contains("va") &&
      (MainThreeScene.changeTexture(2), MainThreeScene.setParams({ mainBall: { reflectionColor: 15592674 } })),
    bodyTag.classList.contains("hy") &&
      (MainThreeScene.changeTexture(3), MainThreeScene.setParams({ mainBall: { reflectionColor: 15592674 } })),
    bodyTag.classList.contains("oa") &&
      (MainThreeScene.changeTexture(4), MainThreeScene.setParams({ mainBall: { reflectionColor: 15462387 } })),
    bodyTag.classList.contains("be") &&
      (MainThreeScene.changeTexture(5), MainThreeScene.setParams({ mainBall: { reflectionColor: 6254957 } })),
    bodyTag.classList.contains("hp") &&
      (MainThreeScene.changeTexture(6), MainThreeScene.setParams({ mainBall: { reflectionColor: 15658473 } })),
    bodyTag.classList.contains("ho") &&
      (MainThreeScene.changeTexture(7), MainThreeScene.setParams({ mainBall: { reflectionColor: 15463134 } })),
    bodyTag.classList.contains("md") &&
      (MainThreeScene.changeTexture(8), MainThreeScene.setParams({ mainBall: { reflectionColor: 15660799 } })),
    bodyTag.classList.contains("init") &&
      (MainThreeScene.changeTexture(9, !1), MainThreeScene.setParams({ mainBall: { reflectionColor: 3554679 } }));
};
changeTexture();
...
introAnim.set(introPaths, { drawSVG: "0% 0%" }),
  ...
  introAnim.to(introPaths, { drawSVG: "0 100%", duration: 1, stagger: { amount: 0.6 }, ease: "power4" }, "-=.5"),
  introAnim.to(introPaths, { drawSVG: "100% 100%", stagger: { amount: 0.2 }, duration: 1, ease: "power4.inOut" }),
  introAnim.to(introSVG, { opacity: 0, scale: 0.9, duration: 0.6, ease: "power4" }, "-=.5"),
  introAnim.to(introSpan, { opacity: 0, y: "-100%", duration: 0.6, ease: "power4" }, "<"),
    ...
    var e = {
        ...
        onStart: {
          ...
          render: function (e) {
            if (
              ...
              hamburger.classList.contains("active")
                ? (hambIcon.reverse(),
                  ...
                  menuInner.reverse(),
                  hamburger.classList.remove("active"),
                  gsap.to(".page-to-page svg:first-of-type", { opacity: 1, duration: 0.5, delay: 1 }))
            ...
            bodyTag.classList.contains("init") &&
              gsap.to(glContainer, { xPercent: 0, yPercent: 0, y: "0%", duration: 0.75, ease: "power4.inOut" });
          },
        },
        onReady: {
          render: function (e, t) {
            e.removeClass("is-exiting pending"),
              ...
              bodyTag.classList.contains("init") && gsap.to(glContainer, { y: "0%", duration: 1, ease: customEaseC });
          },
        },
        onAfter: function (e, t) {
          ...
          if (document.querySelector(".about") && !isMobile()) triggerDotAnim();
            ...
            gsap.set(".about #hero h1", { perspective: 400 }),
              gsap.set(e.chars, { transformOrigin: "0% 100%", scale: 6, opacity: 0, rotate: 45, y: window.innerHeight }),
              gsap.to(e.chars, {
                transformOrigin: "0% 100%",
                scale: 1,
                opacity: 1,
          ...
          gsap.utils.toArray(".scroll-to").forEach((e) => {
            ...
            changeTheme(),
            bodyTag.classList.contains("default") || bodyTag.classList.contains("init") || bodyTag.classList.contains("root")
              ? (updateGl(),
                changeTexture(),
                gsap.to(".blur-circle", { scale: 1, opacity: 0.3, delay: 0.35, duration: 1, ease: "power4.inOut" }))
              : setTimeout(function () {
