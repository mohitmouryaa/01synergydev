    ...
    <main id="smooth-wrapper">
        ...
        <div class="content service-detail" data-work="root">
            <div id="breadcrumb">
                ...
                <span class="bs-tech active hero-in">Front-end Development</span>
            </div>
            ...
            <section id="hero" class="grid-inner">
                ...
                <div>
                    <h1>
                        <div class="hero-split chars bs-180 upper red">Front-end</div>
                    ...
                    <div class="bs-grid xs-wrap service-hero">
                        ...
                        <div class="bs-xl-12 bs-xl-os-1 bs-xs-22 bs-xs-os-0 xs-top-1 bs-grid xs-wrap">
                            <p class="bs-xl-5 bs-xs-16 upper bs-14 hero-in-text">Our engineers are artists. They turn designs into animated and interactive user interfaces that leave a lasting impression on your audience. Breathing life into websites through motion and movement is our bread and butter.</p>
                            <p class="bs-xl-5 bs-xl-os-2 bs-xs-22 bs-xs-os-0 xs-top-1 hero-in-text">We rely on power of JavaScript frameworks like React, Angular, and Vue.js to create dynamic and responsive interfaces. We do APIs, optimize websites with Webpack, and ensure cross-browser compatibility. With our front-end tech stack, your web website is not just functional – it's a captivating experience that leaves a lasting impression.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="side-scroll xl-top-3">
                    <article class="side-scroll-item ">
                        <div class="inner">
                            ...
                            <h3 class="bs-60 upper">Set up framework</h3>
                            <p>we develop animations that engage users and bring your digital content to life. Our go-to library for animation is GSAP, a powerful tool that enables us to craft dynamic and smooth animations.</p>
                        </div>
                    </article>
                    <article class="side-scroll-item ">
                        <div class="inner">
                            <h2 class="section-title"><i class="circle-tag"></i><i class="circle-tag"></i>02</h2>
                            <h3 class="bs-60 upper">Custom solutions</h3>
                            <p>We understand that off-the-shelf solutions may fall short in meeting the specific requirements of your organization. That's why we offer bespoke back-end development services. We have the technical prowess to deliver cutting-edge solutions that are future-proof and adaptable as your business evolves.</p>
                        </div>
                    </article>
                    <article class="side-scroll-item ">
                        <div class="inner">
                            <h2 class="section-title"><i class="circle-tag"></i><i class="circle-tag"></i>03</h2>
                            <h3 class="bs-60 upper">API’s</h3>
                            <p>With our extensive experience in API development and integration, we enable your systems, applications, and services to communicate and interact effortlessly. Our team builds robust APIs that facilitate seamless data exchange, empowering your business to leverage the full potential of connected technologies.</p>
                        </div>
                    </article>
                    <article class="side-scroll-item ">
                        <div class="inner">
                            <h2 class="section-title"><i class="circle-tag"></i><i class="circle-tag"></i>04</h2>
                            <h3 class="bs-60 upper">Performance testing</h3>
                            <p>There’s no room for slow loading times or delays. Our team conducts rigorous performance testing to identify bottlenecks and optimize every aspect of your digital platform. We ensure your website or app performs flawlessly, even under heavy traffic, keeping users engaged and satisfied.</p>
                        </div>
                    </article>
                    <article class="side-scroll-item ">
                        <div class="inner">
                            <h2 class="section-title"><i class="circle-tag"></i><i class="circle-tag"></i>05</h2>
                            <h3 class="bs-60 upper">Optimization and QA</h3>
                            <p>Our diligent and thorough quality assurance process ensures that every product we deploy has been extensively road-tested and is ready to go. We kill more bugs than a Coney Island Superintendent.</p>
                        </div>
                    </article>
                </div>
            </section>
            ...
            <section class="all-services grid-inner bs-grid xl-top-5 xs-top-4 xs-wrap">
                ...
                <div class="bs-xl-11 bs-xs-22 xs-top-1">
                    <ul class="service-list bs-30">
                        ...
                        <li class="split lines selected"><a href="../services/front-end-development"><span>Front-end development</span></a></li>
