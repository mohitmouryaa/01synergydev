<script type="text/javascript" defer>
  ...
  function smoothScroll() {
    if (!isMobile() && window.innerWidth > 768) {
      ...
      return (
        ...
        gsap.utils.toArray(".scroll-to2").forEach((e) => {
          const t = e.dataset.scroll;
          e.addEventListener("click", function() {
            smoother.scrollTo("#" + t, !0, "top 0%");
          });
  ...
  const menuOpen = function() {
    menuBgAnim.to("#pageBgAnim", {
      ...
      isMobile() ?
      isMobile() && menuBgAnim.to(".page-to-page svg", {
        yPercent: 0,
        duration: 0.6,
        ease: "expo.out"
      }, "<") :
        ...
        gsap.set(a, {
          ...
          e.forEach((e) => {
            e.addEventListener("click", function() {
              ...
              gsap.to(t, {
                ...
                (o.classList.add("last"), gsap.to(".progress-total", {
                  opacity: 1,
                  duration: 0.4,
                  ease: "power4"
                }));
          ...
          a.addEventListener("click", function() {
            ...
            document.querySelector('[data-step="1"]').classList.contains("active") &&
              ...
              document.querySelector('[data-step="5"]').classList.contains("active") ||
              (o.classList.remove("last"), gsap.to(".progress-total", {
                opacity: 0.3,
                duration: 0.4,
                ease: "power4"
              })),
  ...
  const glIn = function() {
      bodyTag.classList.contains("init") &&
        !isMobile() &&
        (MainThreeScene.start(), gsap.set(glContainer, {
    ...
    glOut = function() {
      bodyTag.classList.contains("init") &&
        !isMobile() &&
        (MainThreeScene.pause(), gsap.set(glContainer, {
          y: (e) => "+=" + -1 * e.offsetHeight,
          zIndex: 2
        })),
        bodyTag.classList.contains("init") ||
  ...
  const changeTexture = function() {
    ...
    bodyTag.classList.contains("default") ?
      ...
      (MainThreeScene.changeTexture(1), MainThreeScene.setParams({
        mainBall: {
          reflectionColor: 6841187
        }
      })),
      bodyTag.classList.contains("va") &&
      (MainThreeScene.changeTexture(2), MainThreeScene.setParams({
        mainBall: {
          reflectionColor: 15592674
        }
      })),
      bodyTag.classList.contains("hy") &&
      (MainThreeScene.changeTexture(3), MainThreeScene.setParams({
        mainBall: {
          reflectionColor: 15592674
        }
      })),
      bodyTag.classList.contains("oa") &&
      (MainThreeScene.changeTexture(4), MainThreeScene.setParams({
        mainBall: {
          reflectionColor: 15462387
        }
      })),
      bodyTag.classList.contains("be") &&
      (MainThreeScene.changeTexture(5), MainThreeScene.setParams({
        mainBall: {
          reflectionColor: 6254957
        }
      })),
      bodyTag.classList.contains("hp") &&
      (MainThreeScene.changeTexture(6), MainThreeScene.setParams({
        mainBall: {
          reflectionColor: 15658473
        }
      })),
      bodyTag.classList.contains("ho") &&
      (MainThreeScene.changeTexture(7), MainThreeScene.setParams({
        mainBall: {
          reflectionColor: 15463134
        }
      })),
      bodyTag.classList.contains("md") &&
      (MainThreeScene.changeTexture(8), MainThreeScene.setParams({
        mainBall: {
